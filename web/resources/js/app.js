$(document).ready(function() {
    ...
    fl.bootstrapValidator({ 
        ...
        submitHandler: function(validator, form, submitButton) {
            ...
            if(usuario == 'barrera0@misena.edu.co' && pass == 'adsi'){
                location.href = "PÁGINA COORDINADOR/coordinador.html"
            }
            //Si no son correctos mandamos un mensage de error...y limpiamos el cuandro de texto del password
           else if(usuario == 'natyan.chaparro@misena.edu.co' && pass == 'adsi'){
                location.href = "PAGINA TECNICO/tecnico.html"
            }
            else if(usuario == 'cliente@nmaint.com' && pass == 'adsi'){
                location.href = "PAGINA INTERVENTOR/interventor.html"
            }
           else{
